...
async def select_funds(behaviour: str):
    ...
    Based on this information and this data {mf_data}, Suggest me one fund in each category and each fund should be from different fund house
    and at most 1 fund per risky asset.
    """
